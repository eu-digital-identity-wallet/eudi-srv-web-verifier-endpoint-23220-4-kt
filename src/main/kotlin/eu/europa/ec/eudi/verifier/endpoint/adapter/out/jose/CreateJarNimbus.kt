...
class CreateJarNimbus : CreateJar {
    ...
    override fun invoke(
        ...
        val signedJar = sign(presentation.requestId, verifierConfig.clientMetaData, jarmEncryptionEphemeralKey, requestObject, walletNonce)
    ...
    internal fun sign(
        ...
        val claimSet = asClaimSet(toNimbus(requestId, clientMetaData, responseMode, jarmEncryptionEphemeralKey), requestObject, walletNonce)
