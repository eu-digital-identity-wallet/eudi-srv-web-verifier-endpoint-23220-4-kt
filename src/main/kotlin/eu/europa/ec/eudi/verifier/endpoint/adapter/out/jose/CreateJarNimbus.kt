...
class CreateJarNimbus : CreateJar {
    ...
    override fun invoke(
        ...
        val signedJar = sign(presentation.requestId, verifierConfig.clientMetaData, ephemeralEcPublicKey, requestObject, walletNonce)
    ...
    internal fun sign(
        ...
        val claimSet = asClaimSet(toNimbus(requestId, clientMetaData, responseMode, ecPublicKey), requestObject, walletNonce)
