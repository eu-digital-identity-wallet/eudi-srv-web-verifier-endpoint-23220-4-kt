...
- `trusted_issuers`: If provided, a list of PEM encoded X509 Certificates (including start and end markers) of the Verifiable Credential Issuers trusted during this Transaction.
